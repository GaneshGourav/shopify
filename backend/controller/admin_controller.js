...
const getAdmin = async (req, res) => {
  try {
    ...
    return res
      .status(400)
      .json({ error: "An error occurred while getting the admin details" });
  }
};
...
const deleteAdmin = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(400)
      .json({ error: "An error occurred while deleting the admin details" });
  }
};
...
const updateAdmin = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(400)
      .json({ error: "An error occurred while updating the admin details" });
  }
};
